  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 to-teal-50 pt-16 sm:pt-20">
      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-6 lg:py-8">
        ...
        >
          <div className="inline-flex items-center justify-center w-16 h-16 bg-cartoon-yellow rounded-full mb-4">
            <Mic className="text-white" size={32} />
          </div>
          <h1 className="text-3xl font-bold text-cartoon-dark mb-2">Pronúncia</h1>
          <p className="text-gray-600">Fale como um nativo</p>
        </motion.div>
            ...
            >
              <Card 
                className={`cursor-pointer hover:shadow-lg transition-all duration-300 border-2 ${
                  lesson.completed ? 'border-green-300 bg-green-50' : 'border-cartoon-yellow'
                }`}
              ...
              >
                <CardContent className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div className="ml-4">
                      {lesson.completed ? (
                        ...
                        <div className="w-6 h-6 bg-cartoon-yellow rounded-full" />
                      )}
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="text-cartoon-yellow font-semibold">+{lesson.xpReward} XP</span>
                  </div>
        ...
        {pronunciationLessons.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">Nenhuma lição de pronúncia disponível ainda.</p>
          </div>
        )}
      </main>
