    ...
    <Layout user={user as any}>
              ...
              <CardContent className="mobile-card-compact sm:p-6">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 space-y-3 sm:space-y-0">
                  <div className="flex items-center space-x-3 min-w-0 flex-1">
                    <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-green-400 to-teal-500 rounded-xl flex items-center justify-center shadow-lg">
                      {lesson.completed ? (
      ...
      {phrasesLessons.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 dark:text-gray-400">Nenhuma lição de frases disponível ainda.</p>
        </div>
      )}
